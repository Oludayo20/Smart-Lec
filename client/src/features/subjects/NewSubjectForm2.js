...
const NewStudentForm = ({ cls }) => {
  ...
  const canSave = [validSubjectName, selectedCls].every(Boolean) && !isLoading;
              ...
              <form onSubmit={onSaveSubject}>
                ...
                <div className="flex flex-col mb-4">
                  ...
                  <h2 className="text-1.3xl mb-4 text-xs6 text-center text-slate-800 italic border-b-2 border-green-500">
                    This is a List of all class in your school...
                  </h2>
                </div>
